...
function Home() {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(
        `https://www.googleapis.com/youtube/v3/playlistItems?playlistId=PLcgglYcXT1JlOODNfEt-iGVoQpzZRT10o&key=AIzaSyAHrnH9CTwkXvUkkWDRJr2fYu8TDYHxPM0&part=snippet&maxResults=48`
      )
        ...
        >
          ...
          <div className="p-4">
            ...
            <ul className="mt-4">
              ...
              <li className="mb-2">
                <Link to="/ProjectsList" className="block hover:text-[#5C8374]">
                  Shorts
                </Link>
              </li>
              <li className="mb-2">
                <Link to="/StudentList" className="block hover:text-[#5C8374]">
                  Subscription
                </Link>
              </li>

              <hr
                className="w-48 h-1 mx-auto bg-gray-100 border-0 
            ...
            <div className="mx-5">
              <div className="flex items-center justify-between ">
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <Link to="/">
                    <div className="flex items-center justify-center gap-1">
                      <img
                        src="https://homes4hope.org/wp-content/uploads/2019/01/youtube-icon-flat-red-play-button-logo-vector.png"
                        alt=""
                        className="w-8"
                      />
                ...
                ${window.innerWidth <= 768 ? "hide-icons" : ""}`}
                  ...
                  <div
                    className="bg-[rgba(76,75,74,0.46)]
                hover:bg-[rgba(76,75,74,0.61)] rounded-3xl py-2.5 px-2.5"
                  >
                    <img src={mic} alt="" className="w-6 h-6" />
                  </div>
                </div>
                ...
                <div className="flex justify-center items-center gap-8">
                  {isLogged ? (
                    ...
                    <div className="flex items-center justify-center gap-4">
                      ...
                      <Link to="/SignIn">
                        <button
                          className="rounded-3xl hover:bg-[rgb(38,56,80)] text-[rgb(62,166,255)] flex justify-center items-center gap-2 px-2 py-1"
            ...
            <div className="flex flex-col justify-center items-center p-5 gap-5">
              ...
              <Link to="/">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <div className="text-white text-xs">Shorts</div>
                </div>
              </Link>
              ...
              <Link to="/">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <div className="text-white text-xs">Subscribtion</div>
                </div>
              </Link>
          ...
          <div className="col-span-11 max-sm:col-span-12">
            ...
            >
              {(searchResult > 0 ? searchResult : data).map((item) => (
                <div
                  className="flex flex-col w-[19rem] rounded-2xl"
                  key={item.id}
                >
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage: `url(${
                          ...
                          "https://via.placeholder.com/640x480" // Fallback image URL
                        })`,
                      }}
                    ></div>
                  </Link>
